                ...
                <div className='flex items-center justify-center w-screen h-screen ring-2 ring-gray-200 rounded-e-lg'>
                    <div className='grid grid-cols-2 w-150 h-100 ring-2 ring-gray-200 rounded-2xl place-items-center  2xl:w-300 2xl:h-180 lg:w-230 lg:h-140 bg-white'>
                        ...
                        <div className='flex items-center justify-center'>
                            <form action="" className='rounded-md h-90 w-70 p-5 bg-white lg:h-120 lg:w-100 2xl:h-160 2xl:w-140'>
                                ...
                                <label htmlFor="fname" className='hidden lg:block 2xl:text-xl'>Username/Email*</label>

                                <div className='relative'>
                                    <input placeholder='Username' type="text" id="fname" name="fname" className='block border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-400 rounded-md mt-2 mb-4 h-8 min-w-full p-3 pl-10 lg:h-10 2xl:h-12 placeholder-gray-200' />
                                ...
                                <label htmlFor="fPassword" className='hidden lg:block 2xl:text-xl'>Password</label>
                                <div className='relative'>
                                    <input placeholder='Password' type="password" id="fPassword" name="fPassword" className='block border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-400 rounded-md mt-2 mb-4 h-8 min-w-full p-3 pl-10 lg:h-10 2xl:h-12 placeholder-gray-200' />
                                ...
                                <button className='border rounded-md min-w-full h-9 mb-5 lg:h-12 2xl:h-14 2xl:mt-5 cursor-pointer bg-black text-white'>Register new user</button>
